...
| **IoT Lead AgripeWeb** | Firmware, campo, pipeline sensores→API | `proactive` | [iot-lead-agripeweb/SOUL.md](iot-lead-agripeweb/SOUL.md), [iot-lead-agripeweb/HEARTBEAT.md](iot-lead-agripeweb/HEARTBEAT.md) |

## Uso no Paperclip

1. Criar agentes na company **AgripeWeb** com os nomes acima.
