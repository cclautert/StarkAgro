...
Issue: https://github.com/cclautert/AgripeWeb/issues/25
...
- `AgripeWebAPI/Models/Entities/SensorAnomaly.cs`
- `AgripeWebAPI/Domain/Commands/Requests/Anomalies/DetectSensorAnomalyRequest.cs`
- `AgripeWebAPI/Domain/Commands/Requests/Anomalies/GetPivotAnomaliesRequest.cs`
- `AgripeWebAPI/Domain/Commands/Responses/Anomalies/SensorAnomalyResponse.cs`
- `AgripeWebAPI/Domain/Handlers/Anomalies/DetectSensorAnomalyHandler.cs`
- `AgripeWebAPI/Domain/Handlers/Anomalies/GetPivotAnomaliesHandler.cs`

## Files Modified

- `AgripeWebAPI/Models/Entities/ReadSensor.cs` — add `bool IsAnomaly`
- `AgripeWebAPI/Models/agpDBContext.cs` — add `SensorAnomalies` collection + 2 indexes
- `AgripeWebAPI/Domain/Commands/Responses/Reads/CreateReadResponse.cs` — add `SensorId`, `UserId`
- `AgripeWebAPI/Domain/Handlers/Reads/CreateReadHandler.cs` — populate new response fields
- `AgripeWebAPI/Domain/Handlers/Pivots/GetIrrigationTrendHandler.cs` — filter `!IsAnomaly`
- `AgripeWebAPI/Controllers/PivotController.cs` — add `GET {pivotId}/anomalies`
- `AgripeWebWorker/Services/MqttWorkerService.cs` — send `DetectSensorAnomalyRequest` after create
- `AgripeWebUI/src/app/services/pivot.service.ts` — add `getAnomalies()`
- `AgripeWebUI/src/app/components/irrigation-dashboard/irrigation-dashboard.component.*` — anomaly badge
