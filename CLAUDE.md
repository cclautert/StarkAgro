...
- Collections: `users`, `pivots`, `sensors`, `read_sensors`, `plant_diagnoses`, `agronomist_clients`, `diagnosis_plans`, `revendas`, `revenda_memberships`, `monitored_areas`, `counters`  
