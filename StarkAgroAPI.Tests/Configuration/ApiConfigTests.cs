...
namespace StarkAgroAPI.Tests.Configuration
{
    public class ApiConfigTests
    {
        ...
        public void AddApiConfiguration_RegistersDbContextAndServices()
        {
            ...
            var vapidSection = new Mock<IConfigurationSection>();
            ...
            configMock.Setup(c => c.GetSection("Vapid")).Returns(vapidSection.Object);
            configMock.Setup(c => c.GetSection("Smtp")).Returns(smtpSection.Object);
            ...
            var dbContextDescriptor = Assert.Single(services, s => s.ServiceType == typeof(StarkAgroAPI.Models.agpDBContext));
