---
name: starkagro-feature-planner
description: |
  Creates a detailed implementation plan for an StarkAgro feature by fetching the GitHub Issue
  ...
  understand the implementation scope before writing any code in the StarkAgro project.
  Always use this skill BEFORE starting any backend implementation.
---

# StarkAgro — Feature Planner
...
2. The relevant entity/entities in `StarkAgroAPI/Models/Entities/` — current fields and collection name
...
## StarkAgro Architecture Quick Reference
