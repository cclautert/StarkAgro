---
name: starkagro-mongo-setup
description: |
  Applies MongoDB schema changes to the StarkAgro project: adds new collections, entity classes,
  ...
  has a non-empty MongoDB Changes section in the StarkAgro project.
  Never use dotnet ef — always use this skill for StarkAgro schema changes.
---

# StarkAgro — MongoDB Setup
...
- `StarkAgroAPI/Models/agpDBContext.cs` — understand the constructor and collection initialization pattern
- The most relevant existing entity in `StarkAgroAPI/Models/Entities/` — understand field conventions

## Step 3: Apply changes

### 3a. New entity class (if needed)

Create in `StarkAgroAPI/Models/Entities/NewEntity.cs`:
...
In `StarkAgroAPI/Models/agpDBContext.cs`, add:
...
Run: `dotnet build StarkAgroAPI/StarkAgroAPI.csproj`
