---
name: agripeweb-backend-expert
description: |
  Implements backend features in the AgripeWeb API following CQRS/MediatR, MongoDB, and REST
  ...
  or any backend code in the AgripeWeb project. Also trigger when the user says "write the
...
```csharp
// AgripeWebAPI/Models/Entities/NewEntity.cs
...
Run `dotnet build AgripeWebAPI/AgripeWebAPI.csproj` and fix any compilation errors before reporting done.
