---
name: starkagro-review
description: |
  Code review skill for the StarkAgro project. Reviews all branch changes before a PR is created,
  ...
  "is this ready to merge", or asks for a code review in the StarkAgro project context.
  Also trigger when the user provides a PR URL, says "review PR #NNN", or wants a pre-merge quality check.
---

# StarkAgro — Code Review
...
Run `dotnet build StarkAgroAPI/StarkAgroAPI.csproj 2>&1`. Any compilation error is **CRITICAL** — report immediately and stop.
