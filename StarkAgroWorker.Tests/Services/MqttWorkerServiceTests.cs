...
namespace StarkAgroWorker.Tests.Services
{
    public class MqttWorkerServiceTests : IDisposable
    {
        ...
        private readonly Mock<ILoRaWanUplinkParser> _mockParser;
        ...
        public MqttWorkerServiceTests()
        {
            ...
            _mockParser = new Mock<ILoRaWanUplinkParser>();
            ...
            _service = new MqttWorkerService(_mockServiceProvider.Object, options, _mockLogger.Object, _mockMqttClient.Object, _mockParser.Object);
        }
        ...
        public async Task ExecuteAsync_ShouldConnectWithCredentials_WhenUsernameConfigured()
        {
            ...
            var service = new MqttWorkerService(_mockServiceProvider.Object, options, _mockLogger.Object, _mockMqttClient.Object, _mockParser.Object);
        ...
        public async Task MessageReceived_ValidPayload_ShouldSendCreateDeviceReadRequest()
        {
            ...
            mockMediator
                ...
                .ReturnsAsync(new StarkAgroAPI.Domain.Commands.Responses.Reads.CreateReadResponse { Id = 1, SensorId = 1, UserId = 10 });
        ...
        public async Task MessageReceived_UnregisteredSensor_LogsWarning_SkipsAnomalyDispatch()
        {
            ...
            mockMediator
                .Setup(m => m.Send(It.IsAny<CreateDeviceReadRequest>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync((StarkAgroAPI.Domain.Commands.Responses.Reads.CreateReadResponse?)null);
            ...
            mockMediator.Verify(m => m.Send(
                It.IsAny<StarkAgroAPI.Domain.Commands.Requests.Anomalies.DetectSensorAnomalyRequest>(),
        ...
        private (Mock<IMediator>, Mock<IServiceScope>, Mock<IServiceScopeFactory>, Mock<IServiceProvider>) SetupMediatorScope()
        {
            var mockMediator = new Mock<IMediator>();
            var mockScope = new Mock<IServiceScope>();
            var mockScopeFactory = new Mock<IServiceScopeFactory>();
            ...
            return (mockMediator, mockScope, mockScopeFactory, mockScopedProvider);
        }
        ...
        public async Task MessageReceived_LoRaWanPayload_ParsesAndSendsSingleRequest()
        {
            ...
            var loRaRead = new StarkAgroAPI.Domain.Commands.Requests.Reads.CreateLoRaWanReadRequest
            {
                Code = "AABBCCDD",
                Humidity = 75m,
                Temperature = 22.7m,
            ...
            mockMediator
                .Setup(m => m.Send(It.IsAny<StarkAgroAPI.Domain.Commands.Requests.Reads.CreateLoRaWanReadRequest>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync(new StarkAgroAPI.Domain.Commands.Responses.Reads.CreateReadResponse { Id = 1, SensorId = 1, UserId = 10 });
            ...
            mockMediator.Verify(m => m.Send(
                It.IsAny<StarkAgroAPI.Domain.Commands.Requests.Reads.CreateLoRaWanReadRequest>(),
                It.IsAny<CancellationToken>()), Times.Once);
        }
        ...
        [Fact]
        public async Task MessageReceived_LegacyPayload_DoesNotCallParser()
        {
            var (mockMediator, _, _, _) = SetupMediatorScope();
