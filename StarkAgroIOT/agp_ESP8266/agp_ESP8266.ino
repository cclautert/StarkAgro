// ============================================================
// StarkAgro — ESP8266 Soil Moisture Node
...
//   and open the "StarkAgro-Setup" configuration portal.
// ============================================================
...
static void connectToWiFi() {
  ...
  Serial.println("[wifi] Connecting (portal: StarkAgro-Setup if unconfigured)...");
  if (!wm.autoConnect("StarkAgro-Setup")) {
